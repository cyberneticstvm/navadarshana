...
class ApiController extends Controller
{
    ...
    {
        $schedules = ClassSchedule::selectRaw("TIME_FORMAT(from_time, '%h:%i %p') AS from_time, TIME_FORMAT(to_time, '%h:%i %p') AS to_time")->whereDate('date', Carbon::now())->orderBy('from_time')->get();
