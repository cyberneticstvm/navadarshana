...
class ApiController extends Controller
{
    ...
    {
        $schedules = ClassSchedule::whereDate('date', Carbon::now())->selectRaw("DATE_FORMAT(from_time, '%h:%i') AS from_time, DATE_FORMAT(to_time, '%h:%i') AS to_time")->orderBy('from_time')->get();
