...
class ReportController extends Controller implements HasMiddleware
{
    ...
    function fetchFee(Request $request)
    {
        ...
        })->selectRaw("id, payment_date, student_id, batch_id, category, payment_mode, amount, discount, sum(amount)-sum(discount) AS fee")->groupBy('id', 'payment_date', 'student_id', 'batch_id', 'category', 'payment_mode', 'amount', 'discount')->get();
        return view('report.fee', compact('inputs', 'branches', 'category', 'fees'));
    }
