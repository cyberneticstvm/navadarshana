...
class AjaxController extends Controller implements HasMiddleware
{
    ...
    function getStudentDetails(String $studentId)
    {
        ...
        if ($student):
            ...
            $op .= "<div class='table-responsive ms-2' style='width:100%'><table class='display table'><thead><tr><th>Batch</th><th>Category</th><th>Amount</th><th>Date</th><th>Fee Month</th></tr><tbody>";
