...
class AjaxController extends Controller implements HasMiddleware
{
    ...
    function getStudentDetails(String $studentId)
    {
        ...
        if ($student):
            ...
            $op .= "<div class='table-responsive ms-2' style='width:100%'><table class='display table'><thead><tr><th>Batch</th><th>Type</th><th>Amount</th><th>Discount</th><th>Date</th></tr><tbody>";
