...
class Student extends Model
{
    ...
    public function notes()
    {
        ...
        return Note::whereIn('topic_id', CourseTopic::whereIn('course_id', Course::whereIn('id', Batch::whereIn('id', $this->activeBatches()->pluck('batch_id'))->pluck('course_id'))->pluck('id'))->pluck('topic_id'))->get();
