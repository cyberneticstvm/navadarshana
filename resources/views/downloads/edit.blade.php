                ...
                <div class="card dz-card">
                    <div class="card-body">
                        <div class="basic-form">
                            {{ html()->form('POST', route('download.update', $download->id))->acceptsFiles()->open() }}
                            <div class="row">
                                <div class="mb-3 col-md-6">
                                    <label class="form-label req">Name / Title</label>
                                    {{ html()->text('name', $download->name)->class("form-control")->placeholder("Name / Title") }}
                                    @error('name')
                                ...
                                <div class="col-md-3">
                                    ...
                                    {{ html()->select($name = 'category_id', $value = $cats, $download->category_id)->class('form-control single-select')->placeholder('Select') }}
                                    @error('category_id')
                            ...
                            <div class="row">
                                <div class="mb-3 col-md-6">
                                    <label class="form-label">Attachment <small>(Allowed types are .pdf and .docx)</small></label>
