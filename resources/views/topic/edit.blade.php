                ...
                <div class="card dz-card">
                    <div class="card-body">
                        <div class="basic-form">
                            {{ html()->form('POST', route('topic.update', encrypt($topic->id)))->open() }}
                            <div class="row">
                                <div class="mb-3 col-md-4">
                                    <label class="form-label req">Topic Name</label>
                                    {{ html()->text('name', $topic->name)->class("form-control")->placeholder("Topic Name") }}
                                    @error('name')
                                ...
                                <div class="col-md-6">
                                    ...
                                    {{ html()->select($name = 'module_id', $value = $modules, $topic->module_id)->class('form-control single-select')->placeholder('Select') }}
                                    @error('module_id')
                            ...
                            <div class="row">
                                <div class="col text-end">
                                    ...
                                    {{ html()->submit("Update Topic")->class("btn btn-submit btn-outline-primary") }}
                                </div>
                            </div>
                            {{ html()->form()->close() }}
                        </div>
