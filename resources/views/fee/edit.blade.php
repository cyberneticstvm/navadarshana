...
<div class="content-body">
    <div class="container">
        <div class="page-titles">
            <h5 class="dashboard_bar">{{ ucfirst($fee->category) }} Fee</h5>
            <ul class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">
                        Home </a>
                </li>
                <li class="breadcrumb-item"><a href="{{ route('branch.register') }}">{{ ucfirst($fee->category) }} Fee</a></li>
                        ...
                        <div class="basic-form">
                            ...
                            <div class="row">
                                <div class="mb-3 col-md-2">
                                    ...
                                    {{ html()->date('payment_date', $fee->payment_date->format('Y-m-d'))->class("form-control") }}
                                    @error('payment_date')
                                ...
                                <div class="col-md-4">
                                    ...
                                    {{ html()->select($name = 'batch_id', $value = $activeBatches, $fee->batch_id)->class('form-control single-select')->placeholder('Select') }}
                                    @error('batch_id')
                                ...
                                <div class="col-md-2">
                                    ...
                                    {{ html()->select($name = 'type', $value = array('advance' => 'Advance', 'balance' => 'Balance', 'full' => 'Full'), $fee->type)->class('form-control single-select')->placeholder('Select') }}
                                    @error('type')
                                ...
                                <div class="mb-3 col-md-2">
                                    ...
                                    {{ html()->number('amount', $fee->amount, '1', '', '1')->class("form-control")->placeholder("0.00") }}
                                    @error('amount')
                                ...
                                <div class="mb-3 col-md-2">
                                    ...
                                    {{ html()->number('discount', $fee->discount, '', '', '')->class("form-control")->placeholder("0.00") }}
                                    @error('discount')
                                ...
                                <div class="col-md-2">
                                    ...
                                    {{ html()->select($name = 'year', $value = $year->pluck('name', 'name'), $fee->year)->class('form-control single-select')->placeholder('Select') }}
                                    @error('year')
                                ...
                                <div class="col-md-2">
                                    ...
                                    {{ html()->select($name = 'payment_mode', $value = $pmodes->pluck('name', 'id'), $fee->payment_mode)->class('form-control single-select')->placeholder('Select') }}
                                    @error('payment_mode')
                                ...
                                <div class="mb-3 col-md-4">
                                    ...
                                    {{ html()->text('remarks', $fee->remarks)->class("form-control")->placeholder("Remarks") }}
                                    @error('remarks')
