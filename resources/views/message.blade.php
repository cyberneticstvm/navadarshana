...
<script>
    $(function() {
        ...
        $('form').submit(function() {
            $(this).closest(".btn-submit").attr("disabled", true);
            $(this).closest(".btn-submit").html("Loading...<span class='spinner-border spinner-border-sm' role='status' aria-hidden='true'></span>");
        });
    });
</script>
<script>
